...
**[Transaction Fraud Detection with Cost-Aware Thresholding](https://github.com/BryanStats/fraud-detection)**
Gradient-boosted model on 590K transactions, evaluated by analyst-queue capacity
rather than accuracy. Time-based validation to prevent leakage, cost-based threshold
selection, SHAP case-narrative explanations, and SQL feature engineering with
Beta-Binomial shrinkage for risk ranking. Installable package with a CLI and unit tests.

---

### Other Work

**[T-Mobile Tuesdays — Multi-Model NLP Topic Analysis](https://github.com/BryanStats/T-Mobile_Tuesdays_Deals_Analysis-NLP-)**
...
**ASA DataFest 2025 · 🏆 Best Insights Award** — Time-series analysis of 6 years of U.S.
office-occupancy data; built models and client-ready dashboards presented to industry
judges. *(Team project)*
